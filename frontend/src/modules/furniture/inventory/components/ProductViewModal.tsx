              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-500 mb-1">Material</p>
                      <p className="text-base font-medium text-gray-900">{product.material || '-'}</p>
                    </div>
                    <div>
                      <p className="text-sm font-medium text-gray-500 mb-1">Número de Dimensiones</p>
                      <p className="text-base font-medium text-gray-900 font-mono">{product.dimensiones || '-'}</p>
                    </div>
                    <div>
