      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-2xl overflow-hidden flex flex-col">
        <div className="flex justify-between items-center p-6 border-b border-gray-100 bg-amber-50/50">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Actualiza el estado físico del mueble tras la revisión.</p>
          </div>
        ...
        <div className="p-6 overflow-y-auto">
          ...
          <div className="bg-gray-50 rounded-xl p-6 mb-8 flex flex-col sm:flex-row gap-6 items-start">
            ...
            <div className="flex-1 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="flex items-center gap-2 text-sm text-gray-600">
                  <span className="font-medium">Material:</span> {product.material || 'N/A'}
                </div>
                <div className="flex items-center gap-2 text-sm text-gray-600">
                  <span className="font-medium">Dimensiones:</span> {product.dimensiones || 'N/A'}
                </div>
              </div>
            </div>
          </div>
          ...
          <form id="maintenanceForm" onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Nuevo Estado del Mueble</label>
                <select 
                  value={estado} 
            ...
            <div>
              ...
              <textarea 
                ...
                placeholder="Detalla qué reparaciones o ajustes se le hicieron al mueble..."
                className="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl focus:ring-amber-500 focus:border-amber-500 text-gray-900 shadow-sm" 
              />
            </div>
          </form>
